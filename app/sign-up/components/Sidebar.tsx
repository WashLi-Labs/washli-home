                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                            <React.Fragment key={step.id}>
                                <div
                                    className={`flex flex-col items-center ${navigationEnabled ? "cursor-pointer" : "cursor-default"
                                        }`}
                                    onClick={() => navigationEnabled && onStepClick(step.id)}
                                >
                                    <div
                                        className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold transition-colors ${isActive

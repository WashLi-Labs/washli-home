            ...
            <div className="mb-4">
                ...
                <div className="relative border-l-2 border-slate-200 ml-3 space-y-8 py-2">
                 ...
                 `}>
                        ...
                        ${isActive ? "text-black" : isCompleted ? "text-slate-600" : "text-slate-400"}
                        `}
                                    >
                                        <span className="inline-block w-5 text-center mr-2 text-xs border rounded-full leading-4 h-5 border-slate-300 bg-white">
                                            {isCompleted ? (
